...
const fetcher = () =>
  fetch(`${process.env.REACT_APP_BACKEND}/leaderboard`).then((response) =>
    response.json()
  );
  ...
  return (
    <>
      ...
      <h1 style={{ display: "grid", placeItems: "center" }}>
        Player:{location.state ? location.state.username : ""}
      </h1>
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        {data && (
          <table
            style={{ width: "20vw", height: "20vh", border: "3px solid black" }}
          >
            <tr>
              <th>Rank</th>
              <th>User</th>
